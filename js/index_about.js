(function($) {
    $(document).on("submit", "#infoUpdateHomeText", function(event){
        ...
        typingTimer = setTimeout(function (){
            if(new_order > 0) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: data,
                    url: urls + 'admin/Product/productlist',
                    success: function(result) {
                        if (result.status === true) {
    ...
    $(document).on("submit", "#infoUpdateProduct", function(event){
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: serialized,
            url: urls + 'admin/Product/productupdate',
            success: function(result) {
                if (result.status === true) {
                    toastr.success("Başarıyla Eklendi.");
                    setTimeout(
    ...
    $(".product-status").change(function(){
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: urls + 'admin/Product/statusproduct',
            success: function(result) {
    ...
    $('.delete-product').jConfirm().on('confirm',function () {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: urls + 'admin/Product/deletesproduct',
            success: function (result) {
                if (result.status === true) {
                    $('#delete'+id).remove();
